...
You are free to embed the #occupy directory map on your website by including the following iframe:
  ...
  <iframe id="embed" src="http://directory.occupy.net/embed/occupytogether/index.html" ></iframe>
...
To post the map in a more restrictive environment, you can post styles inline, like so:
  ...
  <iframe id="embed" src="http://directory.occupy.local/embed/occupytogether/index.html" style="border:0; height:100%; width:100%; position:absolute;"></iframe>
...
If you directly load the URL emebedded in the iframe (http://directory.occupy.net/embed/occupytogether/index.html) into your browser, you can interactively pan and zoom the map, dynamically changing the URLs parameters, which you can then appropriate.