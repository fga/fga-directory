...
<div id="comments" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <a id="suggested-edit-log-toggle" class="icon toggle-comments" href="#"><?php print t( 'Toggle previous suggestions' );?></a>
  <div id="suggested-edit-log">
    <?php print render($title_prefix); ?>
    <h2 class="title"><?php print t('Previously Suggested Edit(s)'); ?></h2>
